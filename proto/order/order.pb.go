...
type OrderItem struct {
	...
	Item *cart.CartItem `protobuf:"bytes,1,opt,name=item,proto3" json:"item,omitempty"`   // 订单商品信息
...
type ListOrderReq struct {
	...
	UserId uint32 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 要查询的用户ID
}
...
type Order struct {
	...
	OrderItems   []*OrderItem `protobuf:"bytes,1,rep,name=order_items,json=orderItems,proto3" json:"order_items,omitempty"`       // 订单商品列表
	OrderId      string       `protobuf:"bytes,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                // 订单ID
	UserId       uint32       `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                  // 用户ID
	UserCurrency string       `protobuf:"bytes,4,opt,name=user_currency,json=userCurrency,proto3" json:"user_currency,omitempty"` // 用户货币类型
...
var file_proto_order_order_proto_rawDesc = []byte{
	...
	0x1a, 0x15, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x61, 0x72, 0x74, 0x2f, 0x63, 0x61, 0x72,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x4f,
	...
	0x52, 0x65, 0x73, 0x70, 0x22, 0x8f, 0x01, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xf2, 0x01,
	...
	0x41, 0x74, 0x22, 0x35, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0xcb, 0x01, 0x0a, 0x0c, 0x4f, 0x72,
	...
	0x64, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x19, 0x5a, 0x17, 0x64, 0x6f, 0x75, 0x79, 0x69,
	0x6e, 0x2d, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6f, 0x72, 0x64,
...
var file_proto_order_order_proto_goTypes = []interface{}{
	(*MarkOrderPaidReq)(nil),  // 0: order.MarkOrderPaidReq
	(*MarkOrderPaidResp)(nil), // 1: order.MarkOrderPaidResp
...
var file_proto_order_order_proto_depIdxs = []int32{
	2,  // 0: order.PlaceOrderReq.address:type_name -> order.Address
	...
	7,  // 8: order.OrderService.ListOrder:input_type -> order.ListOrderReq
	0,  // 9: order.OrderService.MarkOrderPaid:input_type -> order.MarkOrderPaidReq
	6,  // 10: order.OrderService.PlaceOrder:output_type -> order.PlaceOrderResp
	9,  // 11: order.OrderService.ListOrder:output_type -> order.ListOrderResp
	1,  // 12: order.OrderService.MarkOrderPaid:output_type -> order.MarkOrderPaidResp
