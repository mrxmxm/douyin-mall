...
type EmptyCartReq struct {
	...
	UserId uint32 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 要清空的用户ID
}
...
type GetCartResp struct {
	...
	Cart *Cart `protobuf:"bytes,1,opt,name=cart,proto3" json:"cart,omitempty"` // 购物车信息
}
...
var file_proto_cart_cart_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x72, 0x74, 0x22, 0x45, 0x0a,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xa9, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x53, 0x65,
	...
	0x00, 0x42, 0x18, 0x5a, 0x16, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2d, 0x6d, 0x61, 0x6c, 0x6c,
